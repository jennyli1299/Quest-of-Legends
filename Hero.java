...
public class Hero extends InGameCharacter {
    ...
    public void revive() {
        ...
        moveTo(base); // TODO check no Hero on base tile
    }
    ...
    public static void main(String[] args) {
        ...
        Potion MT = new Potion("Mermaid_Tears", 850, 5, 100,
                new String[] { "Health", "Mana", "Strength", "Dexterity", "Agility" });
        Potion Amb = new Potion("Ambrosia", 1000, 8, 150,
                new String[] { "Health", "Mana", "Strength", "Dexterity", "Defense", "Agility" });
        ...
        for (Hero h : ah) {
            if (h != null) {
                ...
                if (count == 0)
                    pr("Please choose a Monster in the battle to attack.");
